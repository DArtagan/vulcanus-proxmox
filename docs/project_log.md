...
Each entry is `slug (date, retiring commit): summary`, with the review link last.
Entries without one predate the review workflow. Sub-bullets carry whatever does
not fit the one-line shape.
